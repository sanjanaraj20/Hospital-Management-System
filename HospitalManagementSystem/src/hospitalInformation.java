...
public class hospitalInformation extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("A hospital Management System (HMS) is an example of health informatics that focuses mainly on\nthe administrational needs of hospoitals.  These systems enhances the ability of health care\nprofessionals to coordinate care by providing a patient's health information and visit history\nat the place and time that it is needed.");
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 257, 756, 179));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(649, 458, -1, -1));
